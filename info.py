...
# ============================
SESSION = environ.get('SESSION', 'SK_MOVIESZ')
API_ID = int(environ.get('API_ID', '23416113'))
API_HASH = environ.get('API_HASH', '5f66046e7129c9bf6e2b3da943ae2993')
...
SPELL_IMG = environ.get("SPELL_IMG", "https://i.ibb.co/TxdZZcqN/photo-2025-03-11-09-00-48-7480806785851326468.jpg")
...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6662808885').split()] # Replace with the actual admin ID(s) to add
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002459964136').split()]  # Channel id for auto indexing (make sure bot is admin)
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002476103988'))  # Log channel id (make sure bot is admin)
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1002374205222'))  # Bin channel id (make sure bot is admin)
DEENDAYAL_MOVIE_UPDATE_CHANNEL = int(environ.get('DEENDAYAL_MOVIE_UPDATE_CHANNEL', '-1002366273711'))  # Notification of those who verify will be sent to your channel
...
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1002442533517').split()]
support_chat_id = environ.get('SUPPORT_CHAT_ID', 'bobbyfdr')  # Support group id (make sure bot is admin)
reqst_channel = environ.get('REQST_CHANNEL_ID', '')  # Request channel id (make sure bot is admin)
AUTH_CHANNEL = [int(fch) if id_pattern.search(fch) else fch for fch in environ.get('AUTH_CHANNEL', '-1002250676177').split()]
MULTI_FSUB = [int(channel_id) for channel_id in environ.get('MULTI_FSUB', '-1002250676177').split() if re.match(r'^-?\d+$', channel_id)]  # Channel for force sub (make sure bot is admin)
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://rathodsandeep43071:OKNDsmuNYk5TjKIj@cluster0.gus45.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://rathodsandeep43071:k731qhs1cmu9TmCV@cluster0.doeoy.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+475lIeQ81jo3ZTE1')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+gR9Czl9KCewwOTM9')
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/SK_MOVIESZ')
DEENDAYAL_MOVIE_UPDATE_CHANNEL_LNK = environ.get('DEENDAYAL_MOVIE_UPDATE_CHANNEL_LNK', 'https://t.me/+PmeM2mS6WzNkNTJl')
